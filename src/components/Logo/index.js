  ...
  <Link to='/'>
    ...
    >
      <defs>
        ...
        >
          <stop offset={0} stopColor='#1573fe' />
          <stop
            offset={1}
            stopColor='rgba(18.14825229110512%,64.85714285714286%,16.202048517520215%,0.797)'
          />
        </linearGradient>
        <filter
        ...
        >
          <feFlood
            floodColor='rgba(100%,85.09803921568628%,85.09803921568628%,0.388)'
            result='flood'
          />
          <feComposite
            operator='in'
